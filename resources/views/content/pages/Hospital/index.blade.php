...
@section('content')
    ...
    {{-- modalStoreData --}}
    @include('content.pages.Hospital.modalStoreData')

    {{-- modalPreView --}}
    @include('content.pages.Hospital.modalPreView')
...
@section('page-script')
    ...
    <script>
        $(document).ready(function() {
            ...
            // ปุ่ม Preview ข้อมูล
            $('.tb_Hospital').on('click', '.previewData', function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('Hospital.getDataEdit') }}",
                    data: {
                        '_token': "{{ csrf_token() }}",
                        'id': id,
                    },
            ...
            $('.tb_Hospital').on('click', '.btnDel', function() {
            ...
            //ปุ่มแก้ไข
            $('.tb_Hospital').on('click', '.btnEdit', function() {
                var id = $(this).attr("data-id");
            ...
            // ข้อมูลของตาราง
            var table = $('.tb_Hospital').DataTable({
                ajax: {
