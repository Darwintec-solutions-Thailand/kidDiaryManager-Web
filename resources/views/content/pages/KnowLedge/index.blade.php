...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-datatable table-responsive">
            ...
            <table class="tb_KnowLedge table">
                <thead>
                    <tr>
                        <th></th>
                        <th>ลำดับ</th>
    ...
    {{-- modalStoreData --}}
    @include('content.pages.KnowLedge.modalStoreData')

    {{-- modalPreView --}}
    @include('content.pages.KnowLedge.modalPreView')
...
@section('page-script')
    ...
    <script>
        $(document).ready(function() {
            ...
            // ปุ่ม Preview ข้อมูล
            $('.tb_KnowLedge').on('click', '.previewData', function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('KnowLedge.getDataEdit') }}",
                    data: {
                        '_token': "{{ csrf_token() }}",
                        'id': id,
                    },
            ...
            $('.tb_KnowLedge').on('click', '.btnDel', function() {
            ...
            //ปุ่มแก้ไข
            $('.tb_KnowLedge').on('click', '.btnEdit', function() {
                var id = $(this).attr("data-id");
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        $("#groupId").val(result.group_id).change();
                    },
                    error: function(xhr, status, error) {
                        console.log("getDataJSTree : xhr", xhr.responseText);
                        console.log(xhr.responseJSON.exception)
            ...
            // ข้อมูลของตาราง
            var table = $('.tb_KnowLedge').DataTable({
                ajax: {
                    "url": "{{ route('KnowLedge.getData') }}",
                    "type": "POST",
                    "data": {
                        '_token': _token
                    },
