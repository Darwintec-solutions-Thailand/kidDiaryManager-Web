            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 m-1">
                        <label for="groupId" class="form-label">กลุ่ม</label>
                        <select id="groupId" class="select2 form-select form-select-lg" data-allow-clear="true">
                            @foreach ($dataKnowLedgeGroup as $item)
