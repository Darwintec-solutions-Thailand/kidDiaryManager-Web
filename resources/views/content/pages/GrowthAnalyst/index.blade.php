...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-datatable table-responsive">
            ...
            <table class="tb_growthAnalyst table">
                <thead>
                    <tr>
                        <th></th>
                        <th>ลำดับ</th>
    ...
    {{-- modalStoreData --}}
    @include('content.pages.GrowthAnalyst.modalStoreData')

    {{-- modalPreView --}}
    @include('content.pages.GrowthAnalyst.modalPreView')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.btnAddData').click(function() {
                ...
                const title_message = $('#title_message').val('')
            ...
            // ปุ่ม Preview ข้อมูล
            $('.tb_growthAnalyst').on('click', '.previewData', function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('GrowthAnalyst.getDataEdit') }}",
                    data: {
                        '_token': "{{ csrf_token() }}",
                        'id': id,
                    },
                    success: function(result) {
                        // console.log(result)
                        //นำข้อมูลไปแสดง
                        $('.headerPreView').append(result.title_message);
                        $('.bodyPreview').append(result.description);
            ...
            $('.tb_growthAnalyst').on('click', '.btnDel', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "{{ route('GrowthAnalyst.destroy') }}",
                            data: {
                                '_token': "{{ csrf_token() }}",
                                'id': id,
                            },
            ...
            //ปุ่มแก้ไข
            $('.tb_growthAnalyst').on('click', '.btnEdit', function() {
                var id = $(this).attr("data-id");
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        //นำข้อมูลเข้า input
                        $('#title_message').val(result.title_message)
            ...
            // ข้อมูลของตาราง
            var table = $('.tb_growthAnalyst').DataTable({
                ajax: {
                    "url": "{{ route('GrowthAnalyst.getData') }}",
                    "type": "POST",
                    "data": {
                        '_token': _token
                    },
